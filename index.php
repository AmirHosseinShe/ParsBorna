...
<body>
    ...
    <div class="advert">
        <h1 class="h1">درج تبلیغات شما</h1>
    </div>
                ...
                <div class="flex-viewport" style="overflow: hidden; position: relative;">
                    <ul class="slides image-box hotel listing-style1" style="width: 100%; transition-duration: 0.6s; transform: translate3d(-300px, 0px, 0px);">  
                        <li style="margin-left:10px;  width: 350px; float: right; display: block;">
                            <article class="box">
                                <figure> <a href="#" class="hover-effect popup-gallery"><img width="270" height="160" alt="" src="#" ></a> </figure>
                        ...
                        <li style="width: 350px; float: right; display: block;">
                            <article class="box">
                                <figure> <a href="#" class="hover-effect popup-gallery"><img width="270" height="160" alt="" src="#" draggable="false"></a> </figure>
